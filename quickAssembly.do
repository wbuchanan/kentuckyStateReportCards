...
r(~/Desktop/kentuckyStateReportCards/raw)
...
`"`"Sheet 1"' `"Sheet 1"'"')												 ///   
r(/Users/billy/Desktop/kentuckyStateReportCards/raw)
...
y(2014 2015 2016) r(~/Desktop/kentuckyStateReportCards/raw)
...
`"`"Sheet 1"'"') r(~/Desktop/kentuckyStateReportCards/raw)
...
`"`"Special_Education"'"') r(~/Desktop/kentuckyStateReportCards/raw)
...
`"`"Sheet 1"' `"Sheet 1"'"') r(~/Desktop/kentuckyStateReportCards/raw)
